      ...
      datasets: [
        {
          ...
          label: 'Detected',
          pointBackgroundColor: DashboardPageComponent.detectedColor,
          pointBorderColor: points.map((point) => this.costPointColor(this.getCostLevel(point))),
          pointBorderWidth: 2,
          pointHoverBackgroundColor: DashboardPageComponent.detectedColor,
          pointHoverRadius: 6,
          pointRadius: 4,
          tension: 0.28,
          yAxisID: 'counts',
        },
        {
          ...
          label: 'Transferred',
          pointBackgroundColor: DashboardPageComponent.transferredColor,
          pointBorderColor: points.map((point) => this.costPointColor(this.getCostLevel(point))),
          pointBorderWidth: 2,
          pointHoverBackgroundColor: DashboardPageComponent.transferredColor,
          pointHoverRadius: 6,
          pointRadius: 4,
          tension: 0.28,
          yAxisID: 'counts',
        },
        {
          ...
          label: 'Error',
          pointBackgroundColor: DashboardPageComponent.failedColor,
          pointBorderColor: points.map((point) => this.costPointColor(this.getCostLevel(point))),
          pointBorderWidth: 2,
          pointHoverBackgroundColor: DashboardPageComponent.failedColor,
          pointHoverRadius: 6,
          pointRadius: 4,
          tension: 0.28,
          yAxisID: 'counts',
        },
        {
          ...
          label: 'Duration',
          pointBackgroundColor: DashboardPageComponent.durationColor,
          pointBorderColor: points.map((point) => this.costPointColor(this.getCostLevel(point))),
          pointBorderWidth: 2,
          pointHoverBackgroundColor: DashboardPageComponent.durationColor,
          pointHoverRadius: 6,
          pointRadius: 4,
          tension: 0.28,
          yAxisID: 'duration',
